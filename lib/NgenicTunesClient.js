...
module.exports = class NgenicTunesClient {
    ...
    static async getNodeTemperature(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'temperature_C'});
    }

    static async getNodeHumidity(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'humidity_relative_percent'});
    }

    static async getNodeControlValue(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'control_value_C'});
    }

    static async getNodeProcessValue(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'process_value_C'});
    }

    static async getNodeSetpoint(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'setpoint_value_C'});
    }

    static async getNodePower(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'power_kW'});
    }

    static async getNodeProducedPower(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'produced_power_kW'});
    }

    static async getNodeCurrentL1(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'L1_current_A'});
    }

    static async getNodeCurrentL2(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'L2_current_A'});
    }

    static async getNodeCurrentL3(tuneId, nodeId) {
        return await NgenicTunesClient.getNodeMeasurement(tuneId, nodeId, {type: 'L3_current_A'});
    }
