...
module.exports = class MyTuneDriver extends Homey.Driver {
    ...
    try {
      ...
      for (let i = 0; i < response.length; i++) {
        ...
        res.push({
          ...
          data: {
            id: response[i].tuneUuid,
            controllerId: await NgenicTunesClient.getControllerUuid(response[i].tuneUuid),
          }
        });
      } 
    } catch (error) {
